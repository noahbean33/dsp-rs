...
#  define SIGLIB_VERSION 10.60    // Indicates SigLib version being used
...
void SIGLIB_FUNC_DECL SUF_PrintCount(const char*);
void SIGLIB_FUNC_DECL SUF_PrintHigher(const SLData_t, const SLData_t, const char*);
void SIGLIB_FUNC_DECL SUF_PrintLower(const SLData_t, const SLData_t, const char*);
SLError_t SIGLIB_FUNC_DECL SUF_ClearDebugfprintf(void);
SLError_t SIGLIB_FUNC_DECL SUF_Debugfprintf(const char* ArgumentType, ...);
SLError_t SIGLIB_FUNC_DECL SUF_Debugvfprintf(const char* format, va_list);
SLError_t SIGLIB_FUNC_DECL SUF_DebugPrintArray(const SLData_t*, const SLArrayIndex_t);
SLError_t SIGLIB_FUNC_DECL SUF_DebugPrintFixedPointArray(const SLArrayIndex_t*, const SLArrayIndex_t);
...
SLError_t SIGLIB_FUNC_DECL SUF_DebugPrintHigher(const SLData_t, const SLData_t, const char*);
SLError_t SIGLIB_FUNC_DECL SUF_DebugPrintLower(const SLData_t, const SLData_t, const char*);
...
#  define SUF_DebugPrintTime()                                                    \
    {                                                                             \
      time_t aclock;                                                              \
      time(&aclock);                                                              \
      SUF_Debugfprintf("SigLib Debug - Time: %s\n", asctime(localtime(&aclock))); \
    }
const char* SUF_StrError(const SLError_t ErrNo);

// file_io.c
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinReadData(SLData_t SIGLIB_OUTPUT_PTR_DECL*, FILE*, const enum SLEndianType_t,
                                                const SLArrayIndex_t);    // Functions for reading and writing .bin files

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinWriteData(const SLData_t SIGLIB_INPUT_PTR_DECL*, FILE*, const enum SLEndianType_t, const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinReadFile(SLData_t SIGLIB_OUTPUT_PTR_DECL*, const char*, const enum SLEndianType_t, const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinWriteFile(const SLData_t SIGLIB_INPUT_PTR_DECL*, const char*, const enum SLEndianType_t,
                                                 const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_BinFileLength(const char*);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_RawReadData(SLData_t SIGLIB_OUTPUT_PTR_DECL*, FILE*, const enum SLEndianType_t, const SLArrayIndex_t,
                                                const SLArrayIndex_t);    // Functions for reading and writing .pcm files

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_RawWriteData(const SLData_t SIGLIB_INPUT_PTR_DECL*, FILE*, const enum SLEndianType_t, const SLArrayIndex_t,
                                                 const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_RawReadFile(SLData_t SIGLIB_OUTPUT_PTR_DECL*, const char*, const enum SLEndianType_t, const SLArrayIndex_t,
                                                const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_RawWriteFile(const SLData_t SIGLIB_INPUT_PTR_DECL*, const char*, const enum SLEndianType_t,
                                                 const SLArrayIndex_t, const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_RawFileLength(const char*, const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvReadData(SLData_t SIGLIB_OUTPUT_PTR_DECL*, FILE*, const SLData_t, const SLArrayIndex_t,
                                                const SLArrayIndex_t);    // Functions for reading and writing .csv files

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvWriteData(const SLData_t SIGLIB_INPUT_PTR_DECL*, FILE*, const SLData_t, const SLArrayIndex_t,
                                                 const SLArrayIndex_t, const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvReadFile(SLData_t SIGLIB_OUTPUT_PTR_DECL*, const char*, const SLData_t, const SLArrayIndex_t,
                                                const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvWriteFile(const SLData_t SIGLIB_INPUT_PTR_DECL*, const char*, const SLData_t, const SLArrayIndex_t,
                                                 const SLArrayIndex_t, const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_CsvReadMatrix(SLData_t SIGLIB_OUTPUT_PTR_DECL**, const char*, const enum SLFileReadFirstRowFlag_t,
                                                  SLArrayIndex_t*,
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_DatReadData(SLData_t SIGLIB_OUTPUT_PTR_DECL*, FILE*,
                                                const SLArrayIndex_t);    // Functions for reading and writing .dat files

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_DatWriteData(const SLData_t SIGLIB_INPUT_PTR_DECL*, FILE*, const SLData_t, const SLArrayIndex_t,
                                                 const SLArrayIndex_t);

SLData_t SIGLIB_FUNC_DECL SUF_DatReadHeader(FILE*);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_DatWriteHeader(FILE*, const SLData_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_SigReadData(SLData_t SIGLIB_OUTPUT_PTR_DECL*, FILE*,
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_SigFileLength(const char*);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WavReadData(SLData_t SIGLIB_OUTPUT_PTR_DECL*, FILE*, const SLWavFileInfo_s,
...
void SIGLIB_FUNC_DECL SUF_WavWriteHeader(FILE*, const SLWavFileInfo_s);

void SIGLIB_FUNC_DECL SUF_WavDisplayInfo(const SLWavFileInfo_s);

SLWavFileInfo_s SIGLIB_FUNC_DECL SUF_WavSetInfo(const SLArrayIndex_t, const SLArrayIndex_t, const short, const short, const short, const short);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WavFileLength(const char*);

SLWavFileInfo_s SIGLIB_FUNC_DECL SUF_WavReadFile(SLData_t SIGLIB_OUTPUT_PTR_DECL*, const char*);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WavWriteFile(const SLData_t SIGLIB_INPUT_PTR_DECL*, const char*, const SLWavFileInfo_s, const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WavWriteFileScaled(const SLData_t SIGLIB_INPUT_PTR_DECL*, const char*, const SLWavFileInfo_s,
                                                       const SLArrayIndex_t);

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_XmtReadData(SLData_t*, FILE*,
                                                const SLArrayIndex_t);    // Functions for reading and writing .xmt files

SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WriteWeightsIntegerCFile(const char*,                              // File name
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WriteWeightsFloatCFile(const char*,                              // File name
                                                           const SLData_t SIGLIB_INPUT_PTR_DECL*,    // Layer 1 weights
                                                           const SLData_t SIGLIB_INPUT_PTR_DECL*,    // Layer 2 weights
                                                           const SLArrayIndex_t,                     // Length of layer 1 weights
                                                           const SLArrayIndex_t,                     // Length of layer 2 weights
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_WriteWeightsBinaryFile(const char*,                              // File name
                                                           const SLData_t SIGLIB_INPUT_PTR_DECL*,    // Layer 1 weights
                                                           const SLData_t SIGLIB_INPUT_PTR_DECL*,    // Layer 2 weights
                                                           const SLArrayIndex_t,                     // Length of layer 1 weights
                                                           const SLArrayIndex_t,                     // Length of layer 2 weights
...
void SIGLIB_FUNC_DECL SDA_Rfft(SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to real input/output array
...
void SIGLIB_FUNC_DECL SDA_Cfft(SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to real input/output array
...
void SIGLIB_FUNC_DECL SDA_Cifft(SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to real input/output array
                                SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to imaginary input/output array
                                const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to FFT coefficients
                                const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Bit reverse mode flag / Pointer to bit
                                                                                // reverse address table
...
void SIGLIB_FUNC_DECL SDA_BitReverseReorder(const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to source array
                                            SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to destination array
                                            const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Bit reverse mode flag / Pointer to bit
                                                                                            // reverse address table
                                            const SLArrayIndex_t);                          // Vector length

void SIGLIB_FUNC_DECL SDA_IndexBitReverseReorder(const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                 SLArrayIndex_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                 const SLArrayIndex_t);                          // Vector length

void SIGLIB_FUNC_DECL SIF_FastBitReverseReorder(SLArrayIndex_t* SIGLIB_OUTPUT_PTR_DECL,    // Bit reverse mode flag / Pointer
                                                                                           // to bit reverse address table
                                                const SLArrayIndex_t);                     // Vector length
...
void SIGLIB_FUNC_DECL SDA_Rfftr(SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to real source array
                                SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to imaginary array
                                const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to FFT coefficients
                                const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Bit reverse mode flag / Pointer to bit
                                                                                // reverse address table
...
void SIGLIB_FUNC_DECL SIF_Fft4(SLData_t* SIGLIB_OUTPUT_PTR_DECL,          // Pointer to FFT coefficients
                               SLArrayIndex_t* SIGLIB_OUTPUT_PTR_DECL,    // Bit reverse mode flag / Pointer
                                                                          // to bit reverse address table
                               const SLArrayIndex_t);                     // FFT length

void SIGLIB_FUNC_DECL SDA_Rfft4(SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to real input/output array
                                SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to imaginary output array
                                const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to FFT coefficients
                                const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Bit reverse mode flag / Pointer to bit
                                                                                // reverse address table
...
void SIGLIB_FUNC_DECL SDA_Cfft4(SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to real input/output array
                                SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to imaginary input/output array
                                const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to FFT coefficients
                                const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Bit reverse mode flag / Pointer to bit
                                                                                // reverse address table
...
void SIGLIB_FUNC_DECL SDA_DigitReverseReorder4(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                               SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                               const SLArrayIndex_t);                    // Vector length

void SIGLIB_FUNC_DECL SDA_IndexDigitReverseReorder4(const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                    SLArrayIndex_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                    const SLArrayIndex_t);                          // Vector length

void SIGLIB_FUNC_DECL SIF_FastDigitReverseReorder4(SLArrayIndex_t* SIGLIB_OUTPUT_PTR_DECL,    // Bit reverse mode flag / Pointer
                                                                                              // to bit reverse address table
                                                   const SLArrayIndex_t);                     // Vector length

void SIGLIB_FUNC_DECL SDA_Cfft2rBy1c(SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to real input array
...
void SIGLIB_FUNC_DECL SDA_Cfft2rBy1cr(SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to real input array
                                      SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to imaginary input array
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary output array
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary output array
                                      const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to FFT coefficients
...
void SIGLIB_FUNC_DECL SDA_Cfft42rBy1c(SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to real input array
                                      SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to imaginary input array
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary output array
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary output array
                                      const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to FFT coefficients
...
void SIGLIB_FUNC_DECL SDA_Cfft42rBy1cr(SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to real input array
                                       SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to imaginary input array
                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary output array
                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary output array
                                       const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to FFT coefficients
...
void SIGLIB_FUNC_DECL SDA_DctII(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to cosine look up table
                                SLArrayIndex_t);                          // DCT length

void SIGLIB_FUNC_DECL SIF_DctIIOrthogonal(SLData_t*,                           // Pointer to square root half parameter
                                          SLData_t*,                           // Pointer to output scale parameter
                                          SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to cosine look up table
                                          const SLArrayIndex_t);               // DCT length

void SIGLIB_FUNC_DECL SDA_DctIIOrthogonal(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                          SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
...
void SIGLIB_FUNC_DECL SDA_Rstft(SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to source array
                                ...
                                SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to real temporary array
                                SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to imaginary temporary array
                                SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to real destination array
                                SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary destination array
                                const SLArrayIndex_t,                           // Source array length
...
void SIGLIB_FUNC_DECL SDA_Ristft(SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to real source array
                                 SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to imaginary source array
                                 const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to window coefficients
                                 const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to FFT coefficients
                                 const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to Bit Reverse Address Table
                                 ...
                                 SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to imaginary temporary array
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to real destination array
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to real normalization array
                                 const SLArrayIndex_t,                           // Number of frames
                                 const SLArrayIndex_t,                           // Hop array length
                                 const SLArrayIndex_t,                           // Window length
                                 const SLArrayIndex_t,                           // FFT length
                                 const SLArrayIndex_t,                           // Log2 FFT length
...
void SIGLIB_FUNC_DECL SIF_FftArb(SLData_t* SIGLIB_OUTPUT_PTR_DECL,                 // Pointer to AWNr coefficients
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_FftArbAllocLength(const SLArrayIndex_t);    // Array length

void SIGLIB_FUNC_DECL SDA_RfftArb(const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to real source array
                                  SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to real destination array
                                  SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary destination array
...
void SIGLIB_FUNC_DECL SDA_CfftArb(const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to real source array
                                  const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to imaginary source array
                                  SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to real destination array
                                  SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary destination array
                                  SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to real temporary array
...
void SIGLIB_FUNC_DECL SDA_CifftArb(const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to real source array
                                   const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to imaginary source array
                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to real destination array
                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary destination array
                                   SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to real temporary array
...
void SIGLIB_FUNC_DECL SIF_FirOverlapAdd(const SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Time Domain Coefficients pointer
                                        ...
                                        SLData_t* SIGLIB_OUTPUT_PTR_DECL,          // Ptr to Imaginary Freq Domain
...
void SIGLIB_FUNC_DECL SIF_FftConvolvePre(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to time domain filter coefficients
                                         SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to real frequency domain filter
                                                                                   // coefficients
                                         SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to imag frequency domain filter
                                                                                   // coefficients
                                         SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to FFT coefficients
                                         SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Bit reverse mode flag / Pointer to
...
void SIGLIB_FUNC_DECL SDA_FftConvolvePre(SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to real time domain source data
                                         ...
                                         const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to real frequency domain
                                                                                         // filter coefficients
                                         const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to imag frequency domain
                                                                                         // filter coefficients
                                         SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to destination array
                                         const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to FFT coefficients
                                         const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Bit reverse mode flag / Pointer to bit
...
void SIGLIB_FUNC_DECL SDA_FftCorrelatePre(SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to real time domain source data
                                          SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to imag time domain source data
                                          SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to real frequency domain filter
                                                                                          // coefficients
                                          SLData_t* SIGLIB_INPUT_PTR_DECL,                // Pointer to imag frequency domain filter
                                                                                          // coefficients
                                          SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to destination array
                                          const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to FFT coefficients
                                          const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Bit reverse mode flag / Pointer to bit
...
void SIGLIB_FUNC_DECL SIF_FirComplexExtendedArray(SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Real state array pointer
                                                  ...
                                                  SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to imaginary filter processing
                                                                                            // coefficients
                                                  SLArrayIndex_t*,                          // Pointer to filter index register
                                                  const SLArrayIndex_t);                    // Filter length
...
SLError_t SIGLIB_FUNC_DECL SIF_FirLowPassFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Filter coeffs array
                                                const SLData_t,                      // Filter cut off frequency
                                                const enum SLWindow_t,               // Window type
                                                const SLArrayIndex_t);               // Filter length

SLError_t SIGLIB_FUNC_DECL SIF_FirHighPassFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Filter coeffs array
                                                 const SLData_t,                      // Filter cut off frequency
                                                 const enum SLWindow_t,               // Window type
                                                 const SLArrayIndex_t);               // Filter length

SLError_t SIGLIB_FUNC_DECL SIF_FirBandPassFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Filter coeffs array
                                                 const SLData_t,                      // Filter centre frequency
                                                 const SLData_t,                      // Filter bandwidth
                                                 const enum SLWindow_t,               // Window type
                                                 const SLArrayIndex_t);               // Filter length

void SIGLIB_FUNC_DECL SIF_FirLowPassFilterWindow(SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Filter coeffs array
                                                 const SLData_t,                           // Filter cut off frequency
                                                 const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to window coefficients
                                                 const SLArrayIndex_t);                    // Filter length

void SIGLIB_FUNC_DECL SIF_FirHighPassFilterWindow(SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Filter coeffs array
                                                  const SLData_t,                           // Filter cut off frequency
                                                  const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to window coefficients
                                                  const SLArrayIndex_t);                    // Filter length

void SIGLIB_FUNC_DECL SIF_FirBandPassFilterWindow(SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Filter coeffs array
                                                  const SLData_t,                           // Filter centre frequency
                                                  const SLData_t,                           // Filter bandwidth
                                                  const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to window coefficients
                                                  const SLArrayIndex_t);                    // Filter length

SLFixData_t SIGLIB_FUNC_DECL SUF_FirKaiserApproximation(const SLData_t,     // Pass-band cut off frequency
                                                        const SLData_t,     // Stop-band cut off frequency
                                                        const SLData_t,     // Pass-band ripple
                                                        const SLData_t,     // Stop-band attenuation
                                                        const SLData_t);    // Sample rate (Hz)

SLFixData_t SIGLIB_FUNC_DECL SUF_FirHarrisApproximation(const SLData_t,     // Pass-band cut off frequency
                                                        const SLData_t,     // Stop-band cut off frequency
                                                        const SLData_t,     // Stop-band attenuation
                                                        const SLData_t);    // Sample rate (Hz)

SLFixData_t SIGLIB_FUNC_DECL SUF_FirHarrisMultirateApproximation(const SLData_t,     // Pass-band cut off frequency
                                                                 const SLData_t,     // Stop-band cut off frequency
                                                                 const SLData_t,     // Stop-band attenuation
                                                                 const SLData_t,     // M
                                                                 const SLData_t);    // Sample rate (Hz)

void SIGLIB_FUNC_DECL SIF_FirMatchedFilter(SLData_t* SIGLIB_INPUT_PTR_DECL,     // Source signal
...
void SIGLIB_FUNC_DECL SDA_FirLpBpShift(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Source coefficients
                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Destination coefficients
                                       const SLData_t,                           // New centre frequency
                                       const SLArrayIndex_t);                    // Filter length

void SIGLIB_FUNC_DECL SDA_FirLpHpShift(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Source coefficients
                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Destination coefficients
                                       const SLArrayIndex_t);                    // Filter length

void SIGLIB_FUNC_DECL SDA_FirLpHpShiftReflectAroundMinus6dBPoint(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Source coefficients
                                                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Destination coefficients
                                                                 const SLArrayIndex_t);                    // Filter length
...
void SIGLIB_FUNC_DECL SIF_IirOrderN(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to filter state array
                                    SLArrayIndex_t*,                     // Pointer to filter index
                                    const SLArrayIndex_t);               // Filter order

SLData_t SIGLIB_FUNC_DECL SDS_IirOrderN(const SLData_t,                           // Input data sample to be filtered
                                        SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to filter state array
                                        const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to filter coefficients array
                                        SLArrayIndex_t*,                          // Pointer to filter index
                                        const SLArrayIndex_t);                    // Filter order

void SIGLIB_FUNC_DECL SDA_IirOrderN(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to input array
                                    SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                    SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to filter state array
                                    const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to filter coefficients array
                                    SLArrayIndex_t*,                          // Pointer to filter index
...
SLData_t SIGLIB_FUNC_DECL SDS_IirOrderNMac(const SLData_t,                           // Input data sample to be filtered
                                           SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to filter state array
                                           const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to filter coefficients array
                                           SLArrayIndex_t*,                          // Pointer to filter index
                                           const SLArrayIndex_t);                    // Filter order

void SIGLIB_FUNC_DECL SDA_IirOrderNMac(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to input array
                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                       SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to filter state array
                                       const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to filter coefficients array
                                       SLArrayIndex_t*,                          // Pointer to filter index
...
void SIGLIB_FUNC_DECL SDA_IirOrderNDirectFormIITransposed(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to input array
                                                          SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                          SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to filter state array
                                                          const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to filter coefficients array
                                                          const SLArrayIndex_t,                     // Filter order
...
void SIGLIB_FUNC_DECL SDA_IirZeroPhase(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to input source array to be filtered
                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                       SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to filter state array
                                       const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to filter coefficients
...
void SIGLIB_FUNC_DECL SIF_IirZeroPhaseOrderN(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to filter coefficients array
                                             SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal transposed companion matrix
                                             SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal IminusA matrix
                                             SLArrayIndex_t*,                          // Pointer to internal row interchange matrix
                                             SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal scaling factor matrix
                                             SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal feedforward coefficient array
                                             SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal feedback coefficient array
                                             SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to output initialized state array
                                             const SLArrayIndex_t);                    // Filter order

void SIGLIB_FUNC_DECL SDA_IirZeroPhaseOrderN(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to input source array to be filtered
                                             const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to initialized filter state array
                                             const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to filter coefficients
                                             SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal filter state array
                                             SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal padded source array
                                             SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal padded destination array
                                             SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                             const SLArrayIndex_t,                     // Filter order
...
SLData_t SIGLIB_FUNC_DECL SDA_IirModifyFilterGain(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source IIR filter coefficients
...
void SIGLIB_FUNC_DECL SIF_IirLowPassFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to output IIR filter coefficients
                                           const SLData_t,                      // Filter cut-off frequency
                                           const SLData_t);                     // Filter Q factor

void SIGLIB_FUNC_DECL SIF_IirHighPassFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to output IIR filter coefficients
                                            const SLData_t,                      // Filter cut-off frequency
                                            const SLData_t);                     // Filter Q factor

void SIGLIB_FUNC_DECL SIF_IirAllPassFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to output IIR filter coefficients
                                           const SLData_t,                      // Filter cut-off frequency
                                           const SLData_t);                     // Filter Q factor

void SIGLIB_FUNC_DECL SIF_IirBandPassFilterConstantSkirtGain(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to output IIR filter coefficients
                                                             const SLData_t,                      // Filter cut-off frequency (low)
                                                             const SLData_t);                     // Filter cut-off frequency (high)

void SIGLIB_FUNC_DECL SIF_IirBandPassFilter0dBPeakGain(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to output IIR filter coefficients
                                                       const SLData_t,                      // Filter cut-off frequency (low)
                                                       const SLData_t);                     // Filter cut-off frequency (high)
...
void SIGLIB_FUNC_DECL SIF_IirLowShelfFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to output IIR filter coefficients
                                            const SLData_t,                      // Filter cut-off frequency
                                            const SLData_t,                      // Filter Q factor
                                            const SLData_t);                     // Filter shelf gain (dB)

void SIGLIB_FUNC_DECL SIF_IirHighShelfFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to output IIR filter coefficients
                                             const SLData_t,                      // Filter cut-off frequency
                                             const SLData_t,                      // Filter Q factor
                                             const SLData_t);                     // Filter shelf gain (dB)

SLData_t SIGLIB_FUNC_DECL SDS_IirRemoveDC(SLData_t,           // Input sample
                                          SLData_t*,          // Previous input sample
                                          SLData_t*,          // Previous output sample
                                          const SLData_t);    // Convergence rate

void SIGLIB_FUNC_DECL SDA_IirRemoveDC(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to input array
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                      SLData_t*,                                // Previous input sample
                                      SLData_t*,                                // Previous output sample
                                      const SLData_t,                           // Convergence rate
...
SLData_t SIGLIB_FUNC_DECL SDS_OnePoleEWMA(const SLData_t,    // Input data
                                          const SLData_t,    // Filter alpha
                                          SLData_t*);        // Filter state

void SIGLIB_FUNC_DECL SDA_OnePoleEWMA(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to input data
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                      const SLData_t,                           // Filter alpha
                                      SLData_t*,                                // Filter state
                                      const SLArrayIndex_t);                    // Array length
...
void SIGLIB_FUNC_DECL SIF_OnePoleHighPass(SLData_t*);    // Filter state

SLData_t SIGLIB_FUNC_DECL SDS_OnePoleHighPass(const SLData_t,    // Input data
                                              const SLData_t,    // Filter alpha
                                              SLData_t*);        // Filter state

void SIGLIB_FUNC_DECL SDA_OnePoleHighPass(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to input data
                                          SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                          const SLData_t,                           // Filter alpha
                                          SLData_t*,                                // Filter state
                                          const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDS_OnePoleHighPassNormalized(const SLData_t,    // Input data
                                                        const SLData_t,    // Filter alpha
                                                        SLData_t*);        // Filter state

void SIGLIB_FUNC_DECL SDA_OnePoleHighPassNormalized(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to input data
                                                    SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                    const SLData_t,                           // Filter alpha
                                                    SLData_t*,                                // Filter state
                                                    const SLArrayIndex_t);                    // Array length
...
SLData_t SDS_OnePoleCutOffFrequencyToFilterCoeff(const SLData_t,     // Cut-off frequency
                                                 const SLData_t);    // Sample rate (Hz)

SLData_t SDS_OnePoleHighPassCutOffFrequencyToFilterCoeff(const SLData_t,     // Cut-off frequency
                                                         const SLData_t);    // Sample rate (Hz)
...
void SIGLIB_FUNC_DECL SDA_IirNegateAlphaCoeffs(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source filter coefficients array
                                               SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination filter
                                                                                         // coefficients array
                                               const SLArrayIndex_t);                    // Number of biquads
...
void SIGLIB_FUNC_DECL SDA_SplitIIRFilterCoefficients(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to SigLib filter coefficients
                                                     SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to feedforward filter coefficients
                                                     SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to feedback filter coefficients
                                                     const SLArrayIndex_t);                    // Number of biquads

void SIGLIB_FUNC_DECL SDA_MergeIIRFilterCoefficients(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to feedforward filter coefficients
                                                     const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to feedback filter coefficients
                                                     SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to SigLib filter coefficients
                                                     const SLArrayIndex_t);                    // Number of biquads

void SIGLIB_FUNC_DECL SDA_SplitIIROrderNFilterCoefficients(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to SigLib filter coefficients
                                                           SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to feedforward filter coefficients
                                                           SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to feedback filter coefficients
                                                           const SLArrayIndex_t);                    // Filter order

void SIGLIB_FUNC_DECL SDA_MergeIIROrderNFilterCoefficients(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to feedforward filter coefficients
                                                           SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to feedback filter coefficients
                                                           SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to SigLib filter coefficients
                                                           const SLArrayIndex_t);                    // Filter order

SLError_t SIGLIB_FUNC_DECL
SDA_IirOrderNInitializeCoefficients(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to feedforward coefficients
                                    const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to feedback coefficients
                                    SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to state array initialized values
                                    SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal transposed companion matrix
                                    SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal IminusA matrix
                                    SLArrayIndex_t*,                          // Pointer to internal row interchange matrix
                                    SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to internal scaling factor matrix
...
void SIGLIB_FUNC_DECL SIF_HilbertTransformerFirFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to FIR taps
                                                      const SLArrayIndex_t);               // Filter length

SLData_t SIGLIB_FUNC_DECL SIF_GoertzelIirFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to state array
                                                const SLData_t,                      // Filter frequency
                                                const SLArrayIndex_t);               // Filter length

void SIGLIB_FUNC_DECL SDA_GoertzelIirFilter(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to input data
                                            SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                            SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to state array
                                            const SLData_t,                           // Filter coefficient
                                            const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDS_GoertzelIirFilter(const SLData_t,                     // Source value
                                                SLData_t* SIGLIB_INOUT_PTR_DECL,    // Pointer to state array
                                                const SLData_t);                    // Filter coefficient
...
void SIGLIB_FUNC_DECL SIF_GaussianFirFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to filter coefficients
                                            const SLData_t,                      // Standard deviation of the distribution
                                            const SLArrayIndex_t);               // Filter length

void SIGLIB_FUNC_DECL SIF_GaussianFirFilter2(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to filter coefficients
                                             const SLData_t,                      // Filter bandwidth
                                             const SLArrayIndex_t);               // Filter length

void SIGLIB_FUNC_DECL SIF_RaisedCosineFirFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to filter coefficients
                                                const SLData_t,                      // Symbol period
                                                const SLData_t,                      // Alpha
                                                const SLArrayIndex_t);               // Filter length

void SIGLIB_FUNC_DECL SIF_RootRaisedCosineFirFilter(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to filter coefficients
                                                    const SLData_t,                      // Symbol period
                                                    const SLData_t,                      // Alpha
                                                    const SLArrayIndex_t);               // Filter length
...
SLArrayIndex_t SIGLIB_FUNC_DECL SUF_EstimateBPFirFilterLength(const SLData_t,           // Sample rate (Hz)
                                                              const SLData_t,           // Centre frequency
                                                              const SLArrayIndex_t,     // Minimum filter length
                                                              const SLArrayIndex_t);    // Maximum filter length

void SIGLIB_FUNC_DECL SUF_EstimateBPFirFilterError(const SLData_t,                       // Sample rate (Hz)
                                                   const SLData_t,                       // Centre frequency
                                                   const SLArrayIndex_t,                 // Minimum filter length
                                                   const SLArrayIndex_t,                 // Maximum filter length
                                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL);    // Pointer to error array

SLData_t SIGLIB_FUNC_DECL SUF_FrequenciesToOctaves(const SLData_t Fl,     // Low frequency
                                                   const SLData_t Fh);    // High frequency

SLData_t SIGLIB_FUNC_DECL SUF_FrequenciesToCentreFreqHz(const SLData_t Fl,     // Low frequency
                                                        const SLData_t Fh);    // High frequency

SLData_t SIGLIB_FUNC_DECL SUF_FrequenciesToQFactor(const SLData_t Fl,     // Low frequency
                                                   const SLData_t Fh);    // High frequency

SLData_t SIGLIB_FUNC_DECL SUF_BandwidthToQFactor(const SLData_t BW);    // Bandwidth

SLData_t SIGLIB_FUNC_DECL SUF_QFactorToBandwidth(const SLData_t QFactor);    // Q Factor

SLData_t SIGLIB_FUNC_DECL SDS_KalmanFilter1D(const SLData_t,          // Measured position
                                             SLKalmanFilter1D_s*);    // Kalman filter structure

void SIGLIB_FUNC_DECL SDS_KalmanFilter2D(const SLData_t,         // Measured position
...
void SIGLIB_FUNC_DECL SDA_LinearMicrophoneArrayBeamPatternLinear(const SLFixData_t,                   // Number of microphones
                                                                 const SLData_t,                      // Microphone spacing (meters)
                                                                 const SLData_t,                      // Source signal frequency (Hz)
                                                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to response angles array
                                                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to response gain array
...
void SIGLIB_FUNC_DECL SDA_MicrophoneArrayBeamPattern(const SLFixData_t,                              // Number of microphones
...
void SIGLIB_FUNC_DECL SDA_MicrophoneArrayBeamPatternLinear(const SLFixData_t,                              // Number of microphones
                                                           const SLMicrophone_s* SIGLIB_INPUT_PTR_DECL,    // Microphone configuration
                                                           const SLData_t,                                 // Source signal frequency
                                                           const SLData_t,    // Source signal radius from centre of microphone array
                                                           SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to response angles array
...
SLData_t SIGLIB_FUNC_DECL SDS_VolumeLinToLog(const SLData_t,     // Source value
                                             const SLData_t,     // The inverse of the peak value of the source input
                                             const SLData_t);    // The peak value of the output value

SLData_t SIGLIB_FUNC_DECL SDS_VolumeLinToLogSqApprox(const SLData_t,     // Source value
                                                     const SLData_t,     // The inverse of the peak value of the source input
                                                     const SLData_t);    // The peak value of the output value

SLData_t SIGLIB_FUNC_DECL SDS_VolumeLinToLogCuApprox(const SLData_t,     // Source value
                                                     const SLData_t,     // The inverse of the peak value of the source input
                                                     const SLData_t);    // The peak value of the output value

SLData_t SIGLIB_FUNC_DECL SDS_VolumeLinToLogQuApprox(const SLData_t,     // Source value
                                                     const SLData_t,     // The inverse of the peak value of the source input
                                                     const SLData_t);    // The peak value of the output value

SLData_t SIGLIB_FUNC_DECL SDS_VolumeLinToLogPowApprox(const SLData_t,     // Source value
                                                      const SLData_t,     // The inverse of the peak value of the source input
                                                      const SLData_t,     // The peak value of the output value
                                                      const SLData_t);    // Power to raise the input value by

SLData_t SIGLIB_FUNC_DECL SDS_VolumeLogToLin(const SLData_t,     // Source value
                                             const SLData_t,     // The inverse of the peak value of the source input
                                             const SLData_t);    // The peak value of the output value

SLData_t SIGLIB_FUNC_DECL SDS_VolumeLogToLinSqApprox(const SLData_t,     // Source value
                                                     const SLData_t,     // The inverse of the peak value of the source input
                                                     const SLData_t);    // The peak value of the output value

SLData_t SIGLIB_FUNC_DECL SDS_VolumeLogToLinCuApprox(const SLData_t,     // Source value
                                                     const SLData_t,     // The inverse of the peak value of the source input
                                                     const SLData_t);    // The peak value of the output value

SLData_t SIGLIB_FUNC_DECL SDS_VolumeLogToLinQuApprox(const SLData_t,     // Source value
                                                     const SLData_t,     // The inverse of the peak value of the source input
                                                     const SLData_t);    // The peak value of the output value

SLData_t SIGLIB_FUNC_DECL SDS_VolumeLogToLinPowApprox(const SLData_t,     // Source value
                                                      const SLData_t,     // The inverse of the peak value of the source input
                                                      const SLData_t,     // The peak value of the output value
                                                      const SLData_t);    // Power to raise the input value by
...
void SIGLIB_FUNC_DECL SDA_LmsUpdate(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to LMS filter state array
...
void SIGLIB_FUNC_DECL SDA_FftDeconvolution(SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to real source array
                                           SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to imaginary source array
...
void SIGLIB_FUNC_DECL SIF_FftDeconvolutionPre(const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to impulse response array
                                              SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to real FT(1/(impulse
                                                                                              // response)) array
                                              SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to imaginary FT(1/(impulse
                                                                                              // response)) array
                                              const SLData_t,                                 // Minimum value to avoid divide by zero
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,          // FFT coefficients
                                              const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // FFT Bit reversed addressing look up table
...
void SIGLIB_FUNC_DECL SDA_FftDeconvolutionPre(SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to real source array
                                              SLData_t* SIGLIB_INOUT_PTR_DECL,                // Pointer to imaginary source array
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to real FT(1/(impulse response)) array
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to imaginary FT(1/(impulse
                                                                                              // response)) array
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,          // FFT coefficients
                                              const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // FFT Bit reversed addressing look up table
                                              const SLArrayIndex_t,                           // FFT length
...
void SIGLIB_FUNC_DECL SIM_Fft2d(const SLImageData_t* SIGLIB_INPUT_PTR_DECL,      // Pointer to source array
                                ...
                                const SLArrayIndex_t* SIGLIB_OUTPUT_PTR_DECL,    // Bit reverse mode flag / Pointer to bit
                                                                                 // reverse address table
...
void SIGLIB_FUNC_DECL SIM_SobelVertical3x3(const SLImageData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                           SLImageData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                           const SLArrayIndex_t,                          // Line length
                                           const SLArrayIndex_t);                         // Column length

void SIGLIB_FUNC_DECL SIM_SobelHorizontal3x3(const SLImageData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                             SLImageData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                             const SLArrayIndex_t,                          // Line length
                                             const SLArrayIndex_t);                         // Column length

void SIGLIB_FUNC_DECL SIM_Median3x3(const SLImageData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                    SLImageData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                    const SLArrayIndex_t,                          // Line length
                                    const SLArrayIndex_t);                         // Column length
...
SLImageData_t SIGLIB_FUNC_DECL SIM_Max(const SLImageData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                       const SLArrayIndex_t);                         // Array length

SLImageData_t SIGLIB_FUNC_DECL SIM_Min(const SLImageData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                       const SLArrayIndex_t);                         // Array length
...
SLComplexRect_s SIGLIB_FUNC_DECL SDS_SignalGeneratePolarGaussianNoise(const SLData_t,    // Noise variance
                                                                      SLData_t*,         // Noise phase offset
                                                                      SLData_t*);        // Noise current value
...
SLComplexRect_s SIGLIB_FUNC_DECL SDS_SignalAddPolarJitterAndGaussianNoise(const SLComplexRect_s,    // Input sample
                                                                          const SLData_t,           // Jitter sine wave frequency
                                                                          const SLData_t,           // Jitter sine wave magnitude
                                                                          SLData_t*,                // Jitter sine wave phase offset
                                                                          const SLData_t,           // Noise variance
...
void SIGLIB_FUNC_DECL SIF_RandomNumber(void);    // void
...
SLData_t SIGLIB_FUNC_DECL SCV_EuclideanDistance(const SLComplexRect_s,     // Complex source vector 1
                                                const SLComplexRect_s);    // Complex source vector 2

SLData_t SIGLIB_FUNC_DECL SCV_EuclideanDistanceSquared(const SLComplexRect_s,     // Complex source vector 1
                                                       const SLComplexRect_s);    // Complex source vector 2
...
void SIGLIB_FUNC_DECL SIF_ViterbiDecoderK3(SLFixData_t*,             // Counts the bits into the output word so they are correctly aligned
                                           ...
                                           SLArrayIndex_t*,          // Offset into state history array - this is used as a
                                                                     // circular pointer
...
void SIGLIB_FUNC_DECL SDA_FrequencyModulateComplex(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Modulating signal source pointer
                                                   ...
                                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Imaginary modulated signal destination
                                                                                             // pointer
                                                   const SLData_t,                           // Carrier frequency
                                                   const SLData_t,                           // Modulation index
                                                   SLData_t*,                                // Pointer to carrier phase
...
SLError_t SIGLIB_FUNC_DECL SIF_CostasQamDemodulate(SLData_t*,                           // VCO phase
                                                   ...
                                                   const SLArrayIndex_t,                // Samples per symbol
                                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to ELG real output
                                                                                        // synchronization delay state array
                                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to ELG imaginary output
                                                                                        // synchronization delay state array
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDS_CostasQamDemodulate(const SLData_t,                           // Source data sample
                                                        ...
                                                        SLFixData_t*,                             // Pointer to trigger updated flag
                                                        const SLArrayIndex_t,                     // Samples per symbol
                                                        SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to ELG real output
                                                                                                  // synchronization delay state array
                                                        SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to ELG imaginary output
                                                                                                  // synchronization delay state array
                                                        SLArrayIndex_t*,                          // Pointer to ELG synchronization delay index
...
#else                                             // The following functions have too many parameters for the TI C3x/C4x
                                                  // compiler
...
SLFixData_t SIGLIB_FUNC_DECL SDS_QpskDifferentialEncode(const SLFixData_t,    // Tx di-bit
                                                        SLFixData_t*);        // Previous Tx quadrant pointer

SLFixData_t SIGLIB_FUNC_DECL SDS_QpskDifferentialDecode(const SLFixData_t,    // Mapped Rx di-bit
                                                        SLFixData_t*);        // Previous Rx di-bit pointer

void SIGLIB_FUNC_DECL SIF_DifferentialEncoder(SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to encoder look-up-table
                                              SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to decoder look-up-table
                                              const SLFixData_t);                       // Word length to encode / decode

SLFixData_t SIGLIB_FUNC_DECL SDS_DifferentialEncode(const SLFixData_t,                      // Source word to encode
...
SLFixData_t SIGLIB_FUNC_DECL SDS_DifferentialDecode(const SLFixData_t,                      // Source word to encode
                                                    SLFixData_t* SIGLIB_INPUT_PTR_DECL,     // Encoder / decoder table
                                                    const SLFixData_t,                      // Word length to encode / decode
                                                    const SLFixData_t,                      // Bit mask for given word length
...
void SIGLIB_FUNC_DECL SIF_OpskModulate(SLData_t* SIGLIB_OUTPUT_PTR_DECL,           // Carrier table pointer
                                       const SLData_t,                             // Carrier phase increment per sample (radians / 2π)
...
void SIGLIB_FUNC_DECL SDA_OpskModulate(const SLFixData_t,                         // Tx tri-bit,
...
void SIGLIB_FUNC_DECL SIF_OpskDemodulate(SLData_t* SIGLIB_INPUT_PTR_DECL,           // Carrier table pointer
                                         const SLData_t,                            // Carrier phase increment per sample (radians / 2π)
                                         const SLArrayIndex_t,                      // Sine table length
                                         SLData_t* SIGLIB_INOUT_PTR_DECL,           // Carrier phase pointer
                                         SLArrayIndex_t* SIGLIB_INOUT_PTR_DECL,     // Sample clock pointer
...
SLFixData_t SIGLIB_FUNC_DECL SDA_OpskDemodulate(const SLData_t* SIGLIB_INPUT_PTR_DECL,     // Source data pointer
                                                const SLData_t* SIGLIB_INPUT_PTR_DECL,     // Carrier table pointer
                                                const SLArrayIndex_t,                      // Sine table length
                                                SLData_t* SIGLIB_INOUT_PTR_DECL,           // Carrier phase pointer
                                                SLArrayIndex_t* SIGLIB_INOUT_PTR_DECL,     // Sample clock pointer
...
SLFixData_t SIGLIB_FUNC_DECL SDA_OpskDemodulateDebug(const SLData_t* SIGLIB_INPUT_PTR_DECL,      // Source data pointer
                                                     const SLData_t* SIGLIB_INPUT_PTR_DECL,      // Carrier table pointer
                                                     const SLArrayIndex_t,                       // Sine table length
                                                     SLData_t* SIGLIB_INOUT_PTR_DECL,            // Carrier phase pointer
                                                     SLArrayIndex_t* SIGLIB_INOUT_PTR_DECL,      // Sample clock pointer
...
void SIGLIB_FUNC_DECL SDA_Multiplex(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source multiplexed array
...
void SIGLIB_FUNC_DECL SDA_Demultiplex(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source multiplexed array
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
...
void SIGLIB_FUNC_DECL SDA_Mux6(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 1
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 2
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 3
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 4
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 5
...
void SIGLIB_FUNC_DECL SDA_Demux6(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 1
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 2
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 3
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 4
...
void SIGLIB_FUNC_DECL SDA_Mux7(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 1
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 2
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 3
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 4
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 5
...
void SIGLIB_FUNC_DECL SDA_Demux7(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 1
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 2
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 3
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 4
...
void SIGLIB_FUNC_DECL SDA_Mux8(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 1
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 2
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 3
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 4
                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 5
...
void SIGLIB_FUNC_DECL SDA_Demux8(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 1
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 2
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 3
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array 4
...
SLData_t SIGLIB_FUNC_DECL SDA_InterpolateLinear1D(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to Y source array
                                                  const SLData_t,                           // Input x value
                                                  const SLArrayIndex_t);                    // Source array length

SLData_t SIGLIB_FUNC_DECL SDA_InterpolateLinear2D(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to X source array
...
void SIGLIB_FUNC_DECL SIF_InterpolateSinc1D(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to sinc LUT array
                                            SLData_t*,                           // Pointer to phase gain
                                            const SLArrayIndex_t,                // Number of adjacent samples
                                            const SLArrayIndex_t);               // Sinc look up table length

void SIGLIB_FUNC_DECL SIF_InterpolateWindowedSinc1D(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to sinc LUT array
                                                    SLData_t*,                           // Pointer to phase gain
                                                    const SLArrayIndex_t,                // Number of adjacent samples
                                                    SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to window LUT array
                                                    const enum SLWindow_t,               // Window type
...
SLData_t SIGLIB_FUNC_DECL SDA_InterpolateSinc1D(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to Y source array
                                                const SLData_t,                           // Input x value
...
SLData_t SIGLIB_FUNC_DECL SDS_InterpolateQuadratic1D(const SLData_t,     // y(0) input sample magnitude
                                                     const SLData_t,     // y(1) input sample magnitude
                                                     const SLData_t,     // y(2) input sample magnitude
                                                     const SLData_t);    // Alpha x

SLData_t SIGLIB_FUNC_DECL SDS_InterpolateQuadraticBSpline1D(const SLData_t,     // y(0) input sample magnitude
                                                            const SLData_t,     // y(1) input sample magnitude
                                                            const SLData_t,     // y(2) input sample magnitude
                                                            const SLData_t);    // Alpha x

SLData_t SIGLIB_FUNC_DECL SDS_InterpolateQuadraticLagrange1D(const SLData_t,     // y(0) input sample magnitude
                                                             const SLData_t,     // y(1) input sample magnitude
                                                             const SLData_t,     // y(2) input sample magnitude
                                                             const SLData_t);    // Alpha x
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_MaxIndex(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                             const SLArrayIndex_t);                    // Array length

SLArrayIndex_t SIGLIB_FUNC_DECL SDA_AbsMaxIndex(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                const SLArrayIndex_t);                    // Array length

SLArrayIndex_t SIGLIB_FUNC_DECL SDA_MinIndex(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                             const SLArrayIndex_t);                    // Array length

SLArrayIndex_t SIGLIB_FUNC_DECL SDA_AbsMinIndex(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                const SLArrayIndex_t);                    // Array length
...
SLData_t SIGLIB_FUNC_DECL SDS_Clip(const SLData_t,              // Source value
...
SLData_t SIGLIB_FUNC_DECL SDS_Threshold(const SLData_t,                   // Source value
...
SLData_t SIGLIB_FUNC_DECL SDS_SoftThreshold(const SLData_t,     // Source value
                                            const SLData_t);    // Threshold
...
SLData_t SIGLIB_FUNC_DECL SDS_ThresholdAndClamp(const SLData_t,                   // Source value
                                                const SLData_t,                   // Threshold
...
SLData_t SIGLIB_FUNC_DECL SDS_Clamp(const SLData_t,                   // Source value
                                    const SLData_t,                   // Threshold
...
SLData_t SIGLIB_FUNC_DECL SDS_Limit(const SLData_t,     // Source value
                                    const SLData_t,     // Minimum value
                                    const SLData_t);    // Maximum value

void SIGLIB_FUNC_DECL SDA_Limit(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                const SLData_t,                           // Minimum value
                                const SLData_t,                           // Maximum value
                                const SLArrayIndex_t);                    // Array length
...
SLData_t SIGLIB_FUNC_DECL SDS_SetMinValue(const SLData_t src,    // Input sample
                                          const SLData_t);       // Minimum value
...
void SIGLIB_FUNC_DECL SIF_Envelope(SLData_t* SIGLIB_INOUT_PTR_DECL);    // Pointer to filter state variable
...
void SIGLIB_FUNC_DECL SDA_Envelope(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                   const SLData_t,                           // Attack coefficient
                                   const SLData_t,                           // Decay coefficient
                                   SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to filter state variable
...
void SIGLIB_FUNC_DECL SIF_EnvelopeRMS(SLData_t* SIGLIB_INPUT_PTR_DECL);    // Pointer to filter state variable
...
void SIGLIB_FUNC_DECL SDA_EnvelopeRMS(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                      const SLData_t,                           // Attack coefficient
                                      const SLData_t,                           // Decay coefficient
                                      SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to filter state variable
...
void SIGLIB_FUNC_DECL SIF_EnvelopeHilbert(SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to Hilbert transform filter
                                                                              // coefficient array
                                          SLData_t* SIGLIB_INOUT_PTR_DECL,    // Pointer to filter state array
                                          SLArrayIndex_t*,                    // Pointer to filter index
...
SLData_t SIGLIB_FUNC_DECL SDS_EnvelopeHilbert(const SLData_t,                           // Source sample
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to Hilbert transform
...
void SIGLIB_FUNC_DECL SDA_EnvelopeHilbert(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                          SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                          const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to Hilbert transform
                                                                                    // filter coefficient array
                                          SLData_t* SIGLIB_INOUT_PTR_DECL,          // Pointer to filter state array
...
SLData_t SIGLIB_FUNC_DECL SDS_InterpolateThreePointQuadraticVertexMagnitude(const SLData_t,     // y0
                                                                            const SLData_t,     // y1
                                                                            const SLData_t);    // y2

SLData_t SIGLIB_FUNC_DECL SDS_InterpolateThreePointQuadraticVertexLocation(const SLData_t,     // y0
                                                                           const SLData_t,     // y1
                                                                           const SLData_t);    // y2

SLData_t SIGLIB_FUNC_DECL SDS_InterpolateArbitraryThreePointQuadraticVertexMagnitude(const SLData_t,     // x0
                                                                                     const SLData_t,     // y0
                                                                                     const SLData_t,     // x1
                                                                                     const SLData_t,     // y1
                                                                                     const SLData_t,     // x2
...
SLData_t SIGLIB_FUNC_DECL SDS_InterpolateArbitraryThreePointQuadraticVertexLocation(const SLData_t,     // x0
                                                                                    const SLData_t,     // y0
                                                                                    const SLData_t,     // x1
                                                                                    const SLData_t,     // y1
                                                                                    const SLData_t,     // x2
...
SLData_t SIGLIB_FUNC_DECL SDA_InterpolateThreePointQuadraticVertexMagnitude(const SLData_t* SIGLIB_INPUT_PTR_DECL);    // Pointer to source array

SLData_t SIGLIB_FUNC_DECL SDA_InterpolateThreePointQuadraticVertexLocation(const SLData_t* SIGLIB_INPUT_PTR_DECL);    // Pointer to source array

SLData_t SIGLIB_FUNC_DECL
SDA_InterpolateArbitraryThreePointQuadraticVertexMagnitude(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                           const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL
SDA_InterpolateArbitraryThreePointQuadraticVertexLocation(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                          const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL
SDA_InterpolateArbitraryThreePointQuadraticPeakVertexMagnitude(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                               const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL
SDA_InterpolateArbitraryThreePointQuadraticPeakVertexLocation(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                              const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDA_FirstMinVertex(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                             const SLArrayIndex_t);                    // Array length

SLArrayIndex_t SIGLIB_FUNC_DECL SDA_FirstMinVertexPos(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                      const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDA_FirstMaxVertex(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                             const SLArrayIndex_t);                    // Array length

SLArrayIndex_t SIGLIB_FUNC_DECL SDA_FirstMaxVertexPos(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                      const SLArrayIndex_t);                    // Array length

void SIGLIB_FUNC_DECL SDA_NLargest(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                   const SLArrayIndex_t,                     // Source array length
                                   const SLArrayIndex_t);                    // Number of values to find

void SIGLIB_FUNC_DECL SDA_NSmallest(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                    SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                    const SLArrayIndex_t,                     // Source array length
                                    const SLArrayIndex_t);                    // Number of values to find
...
void SIGLIB_FUNC_DECL SDA_ComplexInverse(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to real source array 1
                                         const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to imaginary source array 1
                                         SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to real destination array
                                         SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to imaginary destination array
                                         const SLArrayIndex_t);                    // Array lengths
...
void SIGLIB_FUNC_DECL SDA_SumAndDifference(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 1
                                           const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array 2
...
void SIGLIB_FUNC_DECL SDA_Add(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                              const SLData_t,                           // Offset
                              SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                              const SLArrayIndex_t);                    // Array length

void SIGLIB_FUNC_DECL SDA_Subtract(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                   const SLData_t,                           // Offset
                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                   const SLArrayIndex_t);                    // Array length
...
void SIGLIB_FUNC_DECL SIF_OverlapAndAddLinear(SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to the value used to
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDS_DetectNAN(const SLData_t);    // Source sample

SLArrayIndex_t SIGLIB_FUNC_DECL SDA_DetectNAN(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                              const SLArrayIndex_t);                    // Array length
...
void SIGLIB_FUNC_DECL SDA_Log2(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                               SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                               const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDS_LogN(const SLData_t,     // Source value
                                   const SLData_t);    // Base number

void SIGLIB_FUNC_DECL SDA_LogN(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                               SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                               const SLData_t,                           // Base number
                               const SLArrayIndex_t);                    // Array length
...
void SIGLIB_FUNC_DECL SIF_CopyWithIndex(SLArrayIndex_t*);    // Pointer to source array index

SLArrayIndex_t SIGLIB_FUNC_DECL SDA_CopyWithIndex(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                  SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                  SLArrayIndex_t*,                          // Pointer to source array index
                                                  const SLArrayIndex_t,                     // Source array length
...
void SIGLIB_FUNC_DECL SDA_Impulse(SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                  const SLArrayIndex_t);              // Array length
...
SLData_t SIGLIB_FUNC_DECL SDS_VoltageTodBm(const SLData_t,     // Linear power value
                                           const SLData_t);    // Zero dBm Level

void SIGLIB_FUNC_DECL SDA_VoltageTodBm(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                       const SLData_t,                           // Zero dBm level
                                       const SLArrayIndex_t);                    // Array lengths

SLData_t SIGLIB_FUNC_DECL SDS_dBmToVoltage(const SLData_t,     // dBm powervalue
                                           const SLData_t);    // Zero dBm Level

void SIGLIB_FUNC_DECL SDA_dBmToVoltage(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                       const SLData_t,                           // Zero dBm level
                                       const SLArrayIndex_t);                    // Array lengths

SLData_t SIGLIB_FUNC_DECL SDS_VoltageTodB(const SLData_t);    // Linear voltage value

void SIGLIB_FUNC_DECL SDA_VoltageTodB(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                      const SLArrayIndex_t);                    // Array lengths

SLData_t SIGLIB_FUNC_DECL SDS_dBToVoltage(const SLData_t);    // dB value

void SIGLIB_FUNC_DECL SDA_dBToVoltage(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                      const SLArrayIndex_t);                    // Array lengths

SLData_t SIGLIB_FUNC_DECL SDS_PowerTodB(const SLData_t);    // Linear power value

void SIGLIB_FUNC_DECL SDA_PowerTodB(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                    SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                    const SLArrayIndex_t);                    // Array lengths

SLData_t SIGLIB_FUNC_DECL SDS_dBToPower(const SLData_t);    // dB value

void SIGLIB_FUNC_DECL SDA_dBToPower(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                    SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                    const SLArrayIndex_t);                    // Array lengths
...
void SIGLIB_FUNC_DECL SDA_SetMin(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                 const SLData_t,                           // New minimum value
                                 const SLArrayIndex_t);                    // Array lengths

void SIGLIB_FUNC_DECL SDA_SetMax(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                 SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
...
void SIGLIB_FUNC_DECL SIF_AgcEnvelopeDetector(const SLData_t,    // Envelope detector time constant
                                              const SLData_t,    // Sample rate
...
SLData_t SIGLIB_FUNC_DECL SDS_AgcEnvelopeDetector(const SLData_t,     // Source sample
...
void SIGLIB_FUNC_DECL SDA_AgcEnvelopeDetector(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                              SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                              const SLData_t,                           // AGC desired output level
                                              const SLData_t,                           // AGC minimum threshold below which no gain control occurs
                                              const SLData_t,                           // AGC slow attack sensitivity
...
void SIGLIB_FUNC_DECL SIF_Drc(const SLData_t,    // Envelope detector time constant
                              const SLData_t,    // Sample rate
...
SLData_t SIGLIB_FUNC_DECL SDS_Drc(const SLData_t,                  // Input sample
...
void SIGLIB_FUNC_DECL SDA_Drc(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                              SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                              SLData_t*,                                // Pointer to envelope follower state variable
                              const SLData_t,                           // Envelope follower one-pole filter coefficient
                              const SLData_t,                           // Envelope follower threshold to enable DRC functionality
...
void SIGLIB_FUNC_DECL SDA_SortMinToMax2(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array #1
                                        const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array #2
                                        SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array #1
                                        SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array #2
                                        const SLArrayIndex_t);                    // Array length
...
void SIGLIB_FUNC_DECL SDA_SortIndexed(const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to source array
...
void SIGLIB_FUNC_DECL SDA_Shuffle(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                  SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                  const SLArrayIndex_t);                    // Source array length

void SIGLIB_FUNC_DECL SDA_InsertSample(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                       const SLData_t,                           // New sample
                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                       const SLArrayIndex_t,                     // New sample location
                                       const SLArrayIndex_t);                    // Source array length

void SIGLIB_FUNC_DECL SDA_InsertArray(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
...
SLData_t SIGLIB_FUNC_DECL SDA_ExtractSample(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                            SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                            const SLArrayIndex_t,                     // New sample location
                                            const SLArrayIndex_t);                    // Source array length

void SIGLIB_FUNC_DECL SDA_ExtractArray(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
...
void SIGLIB_FUNC_DECL SDA_Pad(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                              SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                              const enum SLPadModeType_t,               // Array extend mode
                              const SLArrayIndex_t,                     // Extension length
                              const SLArrayIndex_t);                    // Array length
...
SLData_t SIGLIB_FUNC_DECL SDA_OrderAnalysis(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                            ...
                                            const enum SLSignalCoherenceType_t,       // Signal coherence type for summing
                                                                                      // orders
...
void SIGLIB_FUNC_DECL SDA_SubtractMax(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                      const SLArrayIndex_t);                    // Array length
...
SLData_t SIGLIB_FUNC_DECL SDA_SampleVariance(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to array
                                             const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDA_PopulationVariance(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to array
                                                 const SLArrayIndex_t);                    // Array length

void SIGLIB_FUNC_DECL SDA_CovarianceMatrix(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source matrix
...
void SIGLIB_FUNC_DECL SDA_ComplexRectSqrt(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                          SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                          const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectInverse(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                             SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                             const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectConjugate(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                               SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                               const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectMagnitude(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                               SLData_t* SIGLIB_OUTPUT_PTR_DECL,                // Pointer to destination array
                                               const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectMagnitudeSquared(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,                // Pointer to destination array
                                                      const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectPhase(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                           SLData_t* SIGLIB_OUTPUT_PTR_DECL,                // Pointer to destination array
                                           const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectMultiply(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                              const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                              SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                              const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectDivide(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                            const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                            SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                            const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectAdd(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                         const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                         SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                         const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectSubtract(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                              const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                              SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                              const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectLog(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                         SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                         const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectExp(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                         SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                         const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectExpj(const SLData_t* SIGLIB_INPUT_PTR_DECL,      // Pointer to source array
                                          SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                                          const SLArrayIndex_t);                      // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectPow(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                         SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                         const SLData_t,                                  // Power
                                         const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectAddScalar(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                               const SLData_t,                                  // Scalar
                                               SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                               const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectSubtractScalar(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                    const SLData_t,                                  // Scalar
                                                    SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                    const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectMultiplyScalar(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                    const SLData_t,                                  // Scalar
                                                    SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                    const SLArrayIndex_t);                           // Array length

void SIGLIB_FUNC_DECL SDA_ComplexRectDivideScalar(const SLComplexRect_s* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                  const SLData_t,                                  // Scalar
                                                  SLComplexRect_s* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                  const SLArrayIndex_t);                           // Array length
...
void SIGLIB_FUNC_DECL SDA_ComplexRectLinearInterpolate(const SLComplexRect_s,                      // Interpolation start point
...
void SIGLIB_FUNC_DECL SMX_Diagonal(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source matrix
                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination matrix
                                   const SLArrayIndex_t,                     // Source matrix # of rows
                                   const SLArrayIndex_t);                    // Source matrix # cols

void SIGLIB_FUNC_DECL SMX_Multiply2(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source matrix 1
...
void SIGLIB_FUNC_DECL SMX_Identity(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Output Matrix pointer
                                   const SLArrayIndex_t);               //  Destination matrix # of rows and columns

void SIGLIB_FUNC_DECL SMX_Eye(SLData_t* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination matrix
...
void SIGLIB_FUNC_DECL SMX_CholeskyDecompose(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source matrix
...
void SIGLIB_FUNC_DECL SMX_LuDecomposeSeparateLU(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Source matrix pointer
                                                SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Lower triangular matrix pointer
                                                SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Upper triangular matrix pointer
                                                const SLArrayIndex_t);                    // Number of rows and columns in matrix

void SIGLIB_FUNC_DECL SMX_ForwardSubstitution(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Lower triangular matrix pointer
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,    // B matrix pointer
                                              SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Y matrix pointer
                                              const SLArrayIndex_t);                    // Number of rows and columns in matrix

void SIGLIB_FUNC_DECL SMX_BackwardSubstitution(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Upper triangular matrix pointer
                                               const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Y matrix pointer
                                               SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // X matrix pointer
                                               const SLArrayIndex_t);                    // Number of rows and columns in matrix
...
void SIGLIB_FUNC_DECL SMX_ShuffleColumns(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source matrix
                                         SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination matrix
...
void SIGLIB_FUNC_DECL SMX_ShuffleRows(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source matrix
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination matrix
                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to temporary array
                                      const SLArrayIndex_t,                     // Number of rows in matrix
                                      const SLArrayIndex_t);                    // Number of columns in matrix

void SIGLIB_FUNC_DECL SMX_CompanionMatrix(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                          SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination matrix
                                          const SLArrayIndex_t);                    // Array length

void SIGLIB_FUNC_DECL SMX_CompanionMatrixTransposed(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                    SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination matrix
                                                    const SLArrayIndex_t);                    // Array length

void SIGLIB_FUNC_DECL SMX_ExtractCategoricalColumn(const SLData_t* SIGLIB_INPUT_PTR_DECL,     // Pointer to source matrix
...
#  define SMX_Fill(OPtr, fillVal, nRows, nCols) SDA_Fill(OPtr, fillVal, (SLArrayIndex_t)(nRows * nCols))

#  define SMX_Ones(OPtr, nRows, nCols) SDA_Ones(OPtr, (SLArrayIndex_t)(nRows * nCols))

#  define SMX_Zeros(OPtr, nRows, nCols) SDA_Zeros(OPtr, (SLArrayIndex_t)(nRows * nCols))

#  define SMX_Add(IPtr1, addVal, OPtr, nRows, nCols) SDA_Add((SLData_t*)IPtr1, addVal, (SLData_t*)OPtr, (SLArrayIndex_t)(nRows * nCols))

#  define SMX_Subtract(IPtr1, IPtr2, OPtr, nRows, nCols) SDA_Subtract((SLData_t*)IPtr1, addVal, (SLData_t*)OPtr, (SLArrayIndex_t)(nRows * nCols))

#  define SMX_Add2(IPtr1, IPtr2, OPtr, nRows, nCols) SDA_Add2((SLData_t*)IPtr1, (SLData_t*)IPtr2, (SLData_t*)OPtr, (SLArrayIndex_t)(nRows * nCols))

#  define SMX_Subtract2(IPtr1, IPtr2, OPtr, nRows, nCols) \
    SDA_Subtract2((SLData_t*)IPtr1, (SLData_t*)IPtr2, (SLData_t*)OPtr, (SLArrayIndex_t)(nRows * nCols))

#  define SMX_Multiply2Piecewise(IPtr1, IPtr2, OPtr, nRows, nCols) \
...
SLNeuralNetworkPrediction_s SIGLIB_FUNC_DECL
SDA_TwoLayer2CategoryNetworkPredict(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to data to classify
...
void SIGLIB_FUNC_DECL SDA_TwoLayerNCategoryNetworkFit(const SLData_t* SIGLIB_INPUT_PTR_DECL,          // Pointer to training data
                                                      const SLArrayIndex_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to categorical data
                                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to layer 1 weights
                                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to layer 2 weights
                                                      SLData_t* SIGLIB_OUTPUT_PTR_DECL,               // Pointer to layer 1 pre activation
...
SLNeuralNetworkPrediction_s SIGLIB_FUNC_DECL
SDA_TwoLayerNCategoryNetworkPredict(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to data to classify
                                    const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to layer 1 weights
                                    const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to layer 2 weights
                                    SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to layer 1 post activation
                                    SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to layer 2 post activation
...
SLNeuralNetworkPrediction_s SIGLIB_FUNC_DECL
SDA_TwoLayer2CategoryWithBiasesNetworkPredict(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to data to classify
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to layer 1 weights
...
SLNeuralNetworkPrediction_s SIGLIB_FUNC_DECL
SDA_TwoLayerNCategoryWithBiasesNetworkPredict(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to data to classify
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to layer 1 weights
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to layer 1 biases
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to layer 2 weights
                                              const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to layer 2 biases
...
SLData_t SIGLIB_FUNC_DECL SDS_ActivationReLU(const SLData_t);    // Source sample

void SIGLIB_FUNC_DECL SDA_ActivationReLU(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                         SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                         const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDS_ActivationReLUDerivative(const SLData_t);    // Source sample

void SIGLIB_FUNC_DECL SDA_ActivationReLUDerivative(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                   SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                   const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDS_ActivationLeakyReLU(const SLData_t,     // Source sample
                                                  const SLData_t);    // Activation function alpha value

void SIGLIB_FUNC_DECL SDA_ActivationLeakyReLU(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                              const SLData_t,                           // Activation function alpha value
                                              SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                              const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDS_ActivationLeakyReLUDerivative(const SLData_t,     // Source sample
                                                            const SLData_t);    // Activation function alpha value

void SIGLIB_FUNC_DECL SDA_ActivationLeakyReLUDerivative(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                        const SLData_t,                           // Activation function alpha value
                                                        SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                        const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDS_ActivationLogistic(const SLData_t);    // Source sample

void SIGLIB_FUNC_DECL SDA_ActivationLogistic(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                             SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                             const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDS_ActivationLogisticDerivative(const SLData_t);    // Source sample

void SIGLIB_FUNC_DECL SDA_ActivationLogisticDerivative(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                                       SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                                       const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDS_ActivationTanH(const SLData_t);    // Source sample

void SIGLIB_FUNC_DECL SDA_ActivationTanH(const SLData_t* SIGLIB_INPUT_PTR_DECL,    // Pointer to source array
                                         SLData_t* SIGLIB_OUTPUT_PTR_DECL,         // Pointer to destination array
                                         const SLArrayIndex_t);                    // Array length

SLData_t SIGLIB_FUNC_DECL SDS_ActivationTanHDerivative(const SLData_t);    // Source sample
