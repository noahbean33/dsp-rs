...
void _stdcall SIF_FastBitReverseReorder(long* SIGLIB_OUTPUT_PTR_DECL,    // Bit reverse mode flag / Pointer
                                                                         // to bit reverse address table
                                        long);                           // Vector length
...
void _stdcall SIF_FastDigitReverseReorder4(long* SIGLIB_OUTPUT_PTR_DECL,    // Bit reverse mode flag / Pointer
                                                                            // to bit reverse address table
                                           long);                           // Vector length
...
void _stdcall SIF_FirOverlapAdd(double* SIGLIB_OUTPUT_PTR_DECL,    // Time Domain Coefficients pointer
                                ...
                                double* SIGLIB_OUTPUT_PTR_DECL,    // Ptr to Imaginary Freq Domain
...
void _stdcall SIF_FftConvolvePre(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to time domain filter coefficients
                                 double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to real frequency domain filter
                                                                    // coefficients
                                 double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to imag frequency domain filter
                                                                    // coefficients
                                 double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to FFT coefficients
                                 long* SIGLIB_INPUT_PTR_DECL,       // Bit reverse mode flag / Pointer to
...
void _stdcall SDA_FftConvolvePre(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to real time domain source data
                                 ...
                                 double* SIGLIB_INPUT_PTR_DECL,     // Pointer to real frequency domain
                                                                    // filter coefficients
                                 double* SIGLIB_INPUT_PTR_DECL,     // Pointer to imag frequency domain
                                                                    // filter coefficients
                                 double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                                 double* SIGLIB_INPUT_PTR_DECL,     // Pointer to FFT coefficients
                                 long* SIGLIB_INPUT_PTR_DECL,       // Bit reverse mode flag / Pointer to bit
...
void _stdcall SDA_FftCorrelatePre(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to real time domain source data
                                  double* SIGLIB_INPUT_PTR_DECL,     // Pointer to imag time domain source data
                                  double* SIGLIB_INPUT_PTR_DECL,     // Pointer to real frequency domain filter
                                                                     // coefficients
                                  double* SIGLIB_INPUT_PTR_DECL,     // Pointer to imag frequency domain filter
                                                                     // coefficients
                                  double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                                  double* SIGLIB_INPUT_PTR_DECL,     // Pointer to FFT coefficients
                                  long* SIGLIB_INPUT_PTR_DECL,       // Bit reverse mode flag / Pointer to bit
...
void _stdcall SIF_FirComplexExtendedArray(double* SIGLIB_OUTPUT_PTR_DECL,    // Real state array pointer
                                          ...
                                          double* SIGLIB_INOUT_PTR_DECL,     // Pointer to imaginary filter processing
                                                                             // coefficients
                                          long*,                             // Pointer to filter index register
                                          long);                             // Filter length
...
void _stdcall SDA_FirLpBpShift(double* SIGLIB_INPUT_PTR_DECL,     // Source coefficients
                               double* SIGLIB_OUTPUT_PTR_DECL,    // Destination coefficients
                               double,                            // New centre frequency
                               long);                             // Filter length

void _stdcall SDA_FirLpHpShift(double* SIGLIB_INPUT_PTR_DECL,     // Source coefficients
                               double* SIGLIB_OUTPUT_PTR_DECL,    // Destination coefficients
                               long);                             // Filter length
...
void _stdcall SIF_IirBandPassFilterConstantSkirtGain(double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to output IIR filter coefficients
                                                     double,                            // Filter cut-off frequency (low)
                                                     double);                           // Filter cut-off frequency (high)

void _stdcall SIF_IirBandPassFilter0dBPeakGain(double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to output IIR filter coefficients
                                               double,                            // Filter cut-off frequency (low)
                                               double);                           // Filter cut-off frequency (high)
...
double _stdcall SDS_OnePoleEWMA(double,      // Input data
                                double,      // Filter alpha
                                double*);    // Filter state

void _stdcall SDA_OnePoleEWMA(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to input data
                              double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                              double,                            // Filter alpha
                              double*,                           // Filter state
                              long);                             // Array length
...
void _stdcall SIF_HilbertTransformerFirFilter(double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to FIR taps
                                              long);                             // Filter length

double _stdcall SIF_GoertzelIirFilter(double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to state array
                                      double,                            // Filter frequency
                                      long);                             // Filter length

void _stdcall SDA_GoertzelIirFilter(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to input data
                                    double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                                    double* SIGLIB_INOUT_PTR_DECL,     // Pointer to state array
                                    double,                            // Filter coefficient
                                    long);                             // Array length

double _stdcall SDS_GoertzelIirFilter(double,                           // Source value
                                      double* SIGLIB_INOUT_PTR_DECL,    // Pointer to state array
                                      double);                          // Filter coefficient
...
void _stdcall SIF_GaussianFirFilter(double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to filter coefficients
                                    double,                            // Standard deviation of the distribution
                                    long);                             // Filter length

void _stdcall SIF_GaussianFirFilter2(double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to filter coefficients
                                     double,                            // Filter bandwidth
                                     long);                             // Filter length

void _stdcall SIF_RaisedCosineFirFilter(double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to filter coefficients
                                        double,                            // Symbol period
                                        double,                            // Alpha
                                        long);                             // Filter length

void _stdcall SIF_RootRaisedCosineFirFilter(double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to filter coefficients
                                            double,                            // Symbol period
                                            double,                            // Alpha
                                            long);                             // Filter length
...
long _stdcall SUF_EstimateBPFirFilterLength(double,    // Sample rate (Hz)
                                            double,    // Centre frequency
                                            long,      // Minimum filter length
                                            long);     // Maximum filter length

void _stdcall SUF_EstimateBPFirFilterError(double,                             // Sample rate (Hz)
                                           double,                             // Centre frequency
                                           long,                               // Minimum filter length
                                           long,                               // Maximum filter length
...
double _stdcall SDS_KalmanFilter1D(double,                  // Measured position
                                   SLKalmanFilter1D_s*);    // Kalman filter structure

void _stdcall SDS_KalmanFilter2D(double,                 // Measured position
...
double _stdcall SDS_VolumeLinToLog(double,     // Source value
                                   double,     // The inverse of the peak value of the source input
                                   double);    // The peak value of the output value

double _stdcall SDS_VolumeLinToLogSqApprox(double,     // Source value
                                           double,     // The inverse of the peak value of the source input
                                           double);    // The peak value of the output value

double _stdcall SDS_VolumeLinToLogCuApprox(double,     // Source value
                                           double,     // The inverse of the peak value of the source input
                                           double);    // The peak value of the output value

double _stdcall SDS_VolumeLinToLogQuApprox(double,     // Source value
                                           double,     // The inverse of the peak value of the source input
                                           double);    // The peak value of the output value

double _stdcall SDS_VolumeLinToLogPowApprox(double,     // Source value
                                            double,     // The inverse of the peak value of the source input
                                            double,     // The peak value of the output value
                                            double);    // Power to raise the input value by

double _stdcall SDS_VolumeLogToLin(double,     // Source value
                                   double,     // The inverse of the peak value of the source input
                                   double);    // The peak value of the output value

double _stdcall SDS_VolumeLogToLinSqApprox(double,     // Source value
                                           double,     // The inverse of the peak value of the source input
                                           double);    // The peak value of the output value

double _stdcall SDS_VolumeLogToLinCuApprox(double,     // Source value
                                           double,     // The inverse of the peak value of the source input
                                           double);    // The peak value of the output value

double _stdcall SDS_VolumeLogToLinQuApprox(double,     // Source value
                                           double,     // The inverse of the peak value of the source input
                                           double);    // The peak value of the output value

double _stdcall SDS_VolumeLogToLinPowApprox(double,     // Source value
                                            double,     // The inverse of the peak value of the source input
                                            double,     // The peak value of the output value
                                            double);    // Power to raise the input value by
...
void _stdcall SIF_FftDeconvolutionPre(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to impulse response array
                                      double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to real FT(1/(impulse
                                                                         // response)) array
                                      double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to imaginary FT(1/(impulse
                                                                         // response)) array
                                      double,                            // Minimum value to avoid divide by zero
                                      double* SIGLIB_INPUT_PTR_DECL,     // FFT coefficients
                                      long* SIGLIB_INPUT_PTR_DECL,       // FFT Bit reversed addressing look up table
...
void _stdcall SDA_FftDeconvolutionPre(double* SIGLIB_INOUT_PTR_DECL,    // Pointer to real source array
                                      ...
                                      double* SIGLIB_INPUT_PTR_DECL,    // Pointer to imaginary FT(1/(impulse
                                                                        // response)) array
                                      double* SIGLIB_INPUT_PTR_DECL,    // FFT coefficients
                                      long* SIGLIB_INPUT_PTR_DECL,      // FFT Bit reversed addressing look up table
                                      long,                             // FFT length
...
void _stdcall SIM_Fft2d(int* SIGLIB_INPUT_PTR_DECL,        // Pointer to source array
                        ...
                        long* SIGLIB_OUTPUT_PTR_DECL,      // Bit reverse mode flag / Pointer to bit
                                                           // reverse address table
...
void _stdcall SIF_ViterbiDecoderK3(long*,      // Counts the bits into the output word so they are correctly aligned
                                   ...
                                   long*,      // Offset into state history array - this is used as a
                                               // circular pointer
...
void _stdcall SDA_FrequencyModulateComplex(double* SIGLIB_INPUT_PTR_DECL,     // Modulating signal source pointer
                                           ...
                                           double* SIGLIB_OUTPUT_PTR_DECL,    // Imaginary modulated signal destination
                                                                              // pointer
                                           double,                            // Carrier frequency
                                           double,                            // Modulation index
                                           double*,                           // Pointer to carrier phase
...
long _stdcall SIF_CostasQamDemodulate(double*,                           // VCO phase
                                      ...
                                      long,                              // Samples per symbol
                                      double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to ELG real output
                                                                         // synchronization delay state array
                                      double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to ELG imaginary output
                                                                         // synchronization delay state array
...
long _stdcall SDS_CostasQamDemodulate(double,                            // Source data sample
                                      ...
                                      long*,                             // Pointer to trigger updated flag
                                      long,                              // Samples per symbol
                                      double* SIGLIB_INOUT_PTR_DECL,     // Pointer to ELG real output
                                                                         // synchronization delay state array
                                      double* SIGLIB_INOUT_PTR_DECL,     // Pointer to ELG imaginary output
                                                                         // synchronization delay state array
                                      long*,                             // Pointer to ELG synchronization delay index
...
long _stdcall SDS_QpskDifferentialEncode(long,      // Tx di-bit
                                         long*);    // Previous Tx quadrant pointer

long _stdcall SDS_QpskDifferentialDecode(long,      // Mapped Rx di-bit
                                         long*);    // Previous Rx di-bit pointer

void _stdcall SIF_DifferentialEncoder(long* SIGLIB_INPUT_PTR_DECL,    // Pointer to encoder look-up-table
                                      long* SIGLIB_INPUT_PTR_DECL,    // Pointer to decoder look-up-table
                                      long);                          // Word length to encode / decode

long _stdcall SDS_DifferentialEncode(long,                            // Source word to encode
...
long _stdcall SDS_DifferentialDecode(long,                            // Source word to encode
                                     long* SIGLIB_INPUT_PTR_DECL,     // Encoder / decoder table
                                     long,                            // Word length to encode / decode
                                     long,                            // Bit mask for given word length
...
void _stdcall SIF_OpskModulate(double* SIGLIB_OUTPUT_PTR_DECL,    // Carrier table pointer
                               double,                            // Carrier phase increment per sample (radians / 2Ï€)
...
void _stdcall SDA_OpskModulate(long,                              // Tx tri-bit,
...
void _stdcall SIF_OpskDemodulate(double* SIGLIB_INPUT_PTR_DECL,    // Carrier table pointer
                                 double,                           // Carrier phase increment per sample (radians / 2Ï€)
                                 long,                             // Sine table length
                                 double* SIGLIB_INOUT_PTR_DECL,    // Carrier phase pointer
                                 long* SIGLIB_INOUT_PTR_DECL,      // Sample clock pointer
...
long _stdcall SDA_OpskDemodulate(double* SIGLIB_INPUT_PTR_DECL,    // Source data pointer
                                 double* SIGLIB_INPUT_PTR_DECL,    // Carrier table pointer
                                 long,                             // Sine table length
                                 double* SIGLIB_INOUT_PTR_DECL,    // Carrier phase pointer
                                 long* SIGLIB_INOUT_PTR_DECL,      // Sample clock pointer
...
long _stdcall SDA_OpskDemodulateDebug(double* SIGLIB_INPUT_PTR_DECL,     // Source data pointer
                                      double* SIGLIB_INPUT_PTR_DECL,     // Carrier table pointer
                                      long,                              // Sine table length
                                      double* SIGLIB_INOUT_PTR_DECL,     // Carrier phase pointer
                                      long* SIGLIB_INOUT_PTR_DECL,       // Sample clock pointer
...
double _stdcall SDS_Limit(double,     // Source value
                          double,     // Minimum value
                          double);    // Maximum value

void _stdcall SDA_Limit(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                        double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                        double,                            // Minimum value
                        double,                            // Maximum value
                        long);                             // Array length
...
void _stdcall SIF_Envelope(double* SIGLIB_INOUT_PTR_DECL);    // Pointer to filter state variable
...
void _stdcall SDA_Envelope(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                           double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                           double,                            // Attack coefficient
                           double,                            // Decay coefficient
                           double* SIGLIB_INOUT_PTR_DECL,     // Pointer to filter state variable
...
void _stdcall SIF_EnvelopeRMS(double* SIGLIB_INPUT_PTR_DECL);    // Pointer to filter state variable
...
void _stdcall SDA_EnvelopeRMS(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                              double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                              double,                            // Attack coefficient
                              double,                            // Decay coefficient
                              double* SIGLIB_INOUT_PTR_DECL,     // Pointer to filter state variable
...
void _stdcall SIF_EnvelopeHilbert(double* SIGLIB_INPUT_PTR_DECL,    // Pointer to Hilbert transform filter
                                                                    // coefficient array
                                  double* SIGLIB_INOUT_PTR_DECL,    // Pointer to filter state array
                                  long*,                            // Pointer to filter index
...
double _stdcall SDS_EnvelopeHilbert(double,                           // Source sample
                                    double* SIGLIB_INPUT_PTR_DECL,    // Pointer to Hilbert transform
...
void _stdcall SDA_EnvelopeHilbert(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                                  double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                                  double* SIGLIB_INPUT_PTR_DECL,     // Pointer to Hilbert transform
                                                                     // filter coefficient array
                                  double* SIGLIB_INOUT_PTR_DECL,     // Pointer to filter state array
...
void _stdcall SIF_OverlapAndAddLinear(double* SIGLIB_INPUT_PTR_DECL,    // Pointer to the value used to
...
double _stdcall SDS_VoltageTodBm(double,     // Linear power value
                                 double);    // Zero dBm Level

void _stdcall SDA_VoltageTodBm(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                               double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                               double,                            // Zero dBm level
                               long);                             // Array lengths

double _stdcall SDS_dBmToVoltage(double,     // dBm powervalue
                                 double);    // Zero dBm Level

void _stdcall SDA_dBmToVoltage(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                               double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                               double,                            // Zero dBm level
                               long);                             // Array lengths

double _stdcall SDS_VoltageTodB(double);    // Linear voltage value

void _stdcall SDA_VoltageTodB(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                              double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                              long);                             // Array lengths

double _stdcall SDS_dBToVoltage(double);    // dB value

void _stdcall SDA_dBToVoltage(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                              double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                              long);                             // Array lengths

double _stdcall SDS_PowerTodB(double);    // Linear power value

void _stdcall SDA_PowerTodB(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                            double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                            long);                             // Array lengths

double _stdcall SDS_dBToPower(double);    // dB value

void _stdcall SDA_dBToPower(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                            double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                            long);                             // Array lengths
...
void _stdcall SIF_AgcEnvelopeDetector(double,      // Envelope detector time constant
                                      double,      // Sample rate
...
double _stdcall SDS_AgcEnvelopeDetector(double,     // Source sample
...
void _stdcall SDA_AgcEnvelopeDetector(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                                      double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                                      double,                            // AGC desired output level
                                      double,                            // AGC minimum threshold below which no gain control occurs
                                      double,                            // AGC slow attack sensitivity
...
void _stdcall SIF_Drc(double,      // Envelope detector time constant
                      double,      // Sample rate
...
double _stdcall SDS_Drc(double,                    // Input sample
...
void _stdcall SDA_Drc(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                      double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination array
                      double*,                           // Pointer to envelope follower state variable
                      double,                            // Envelope follower one-pole filter coefficient
                      double,                            // Envelope follower threshold to enable DRC functionality
...
double _stdcall SDA_OrderAnalysis(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source array
                                  ...
                                  int SLSignalCoherenceType_t,       // Signal coherence type for summing
                                                                     // orders
...
double _stdcall SDA_SampleVariance(double* SIGLIB_INPUT_PTR_DECL,    // Pointer to array
                                   long);                            // Array length

double _stdcall SDA_PopulationVariance(double* SIGLIB_INPUT_PTR_DECL,    // Pointer to array
                                       long);                            // Array length

void _stdcall SDA_CovarianceMatrix(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source matrix
...
void _stdcall SMX_Diagonal(double* SIGLIB_INPUT_PTR_DECL,     // Pointer to source matrix
                           double* SIGLIB_OUTPUT_PTR_DECL,    // Pointer to destination matrix
                           long,                              // Source matrix # of rows
                           long);                             // Source matrix # cols
...
void _stdcall SMX_CholeskyDecompose(double* SIGLIB_INPUT_PTR_DECL,    // Pointer to source matrix
