...
void SIGLIB_FUNC_DECL SDA_Rotate(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t Rotation,
                                 const SLArrayIndex_t ArrayLength)
{
...
void SIGLIB_FUNC_DECL SDA_Reverse(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SIGLIB_FUNC_DECL SDA_Scale(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t MaximumScaledValue,
                                    const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLData_t SIGLIB_FUNC_DECL SDA_MeanSquare(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SIGLIB_FUNC_DECL SDA_MeanSquareError(const SLData_t* SIGLIB_PTR_DECL pSrc1, const SLData_t* SIGLIB_PTR_DECL pSrc2,
...
SLData_t SIGLIB_FUNC_DECL SDA_RootMeanSquare(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_Magnitude(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
...
void SIGLIB_FUNC_DECL SDA_MagnitudeSquared(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                           SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                 // Defined by TI compiler
...
SLData_t SIGLIB_FUNC_DECL SDS_Magnitude(const SLData_t RealSrc, const SLData_t ImagSrc)
{
...
SLData_t SIGLIB_FUNC_DECL SDS_MagnitudeSquared(const SLData_t RealSrc, const SLData_t ImagSrc)
{
...
SLData_t SIGLIB_FUNC_DECL SDS_Phase(const SLData_t RealSrc, const SLData_t ImagSrc)
{
...
void SIGLIB_FUNC_DECL SDA_PhaseWrapped(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                       SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {
...
void SIGLIB_FUNC_DECL SDA_PhaseUnWrapped(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                         SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {
    if ((SDS_Abs(*pSrcReal) < SIGLIB_MIN) && (SDS_Abs(*pSrcImag) < SIGLIB_MIN)) {    // Check for 0. / 0.
...
void SIGLIB_FUNC_DECL SDA_MagnitudeAndPhaseWrapped(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                                   SLData_t* SIGLIB_PTR_DECL pMagnDst, SLData_t* SIGLIB_PTR_DECL pPhaseDst,
                                                   const SLArrayIndex_t ArrayLength)
{
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {
...
void SIGLIB_FUNC_DECL SDA_MagnitudeAndPhaseUnWrapped(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                                     SLData_t* SIGLIB_PTR_DECL pMagnDst, SLData_t* SIGLIB_PTR_DECL pPhaseDst,
                                                     const SLArrayIndex_t ArrayLength)
{
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {
...
void SIGLIB_FUNC_DECL SDA_MagnitudeSquaredAndPhaseWrapped(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                                          SLData_t* SIGLIB_PTR_DECL pMagnDst, SLData_t* SIGLIB_PTR_DECL pPhaseDst,
                                                          const SLArrayIndex_t ArrayLength)
{
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {
...
void SIGLIB_FUNC_DECL SDA_MagnitudeSquaredAndPhaseUnWrapped(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                                            SLData_t* SIGLIB_PTR_DECL pMagnDst, SLData_t* SIGLIB_PTR_DECL pPhaseDst,
                                                            const SLArrayIndex_t ArrayLength)
{
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {
...
void SIGLIB_FUNC_DECL SDA_PhaseWrap(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_PhaseUnWrap(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SIGLIB_FUNC_DECL SDS_Log2(const SLData_t Src)
{
...
void SIGLIB_FUNC_DECL SDA_Log2(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SIGLIB_FUNC_DECL SDS_LogN(const SLData_t Src, const SLData_t baseNumber)
{
  if (SDS_Abs(Src) < SIGLIB_MIN_THRESHOLD) {    // Check for close to zero
    return (SIGLIB_DB_MIN);                     // Return minimum dB value
  } else {
...
void SIGLIB_FUNC_DECL SDA_LogN(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t baseNumber,
                               const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_LogDistribution(SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t start, const SLData_t end,
                                          const SLArrayIndex_t numberOfSteps)
{
...
void SIGLIB_FUNC_DECL SDA_Copy(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_CopyWithStride(const SLData_t* SIGLIB_PTR_DECL pSrc, const SLArrayIndex_t SourceStride, SLData_t* SIGLIB_PTR_DECL pDst,
                                         const SLArrayIndex_t DestStride, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SIF_CopyWithOverlap(SLArrayIndex_t* pSrcIndex)
{
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_CopyWithOverlap(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst,
                                                    SLData_t* SIGLIB_PTR_DECL pOverlap, SLArrayIndex_t* pSrcIndex, const SLArrayIndex_t SrcLength,
                                                    const SLArrayIndex_t OverlapLength, const SLArrayIndex_t DstLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SIF_CopyWithIndex(SLArrayIndex_t* pSrcIndex)
{
  *pSrcIndex = SIGLIB_AI_ZERO;
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_CopyWithIndex(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, SLArrayIndex_t* pSrcIndex,
                                                  const SLArrayIndex_t srcLength, const SLArrayIndex_t strideLength, const SLArrayIndex_t dstLength)
{
  ...
  if (copyLength < dstLength) {    // If copyLength < dstLength then zero pad last array and
                                   // returns length of valid data in output array
...
void SIGLIB_FUNC_DECL SDA_20Log10(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_10Log10(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_LogMagnitude(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                       SLData_t* SIGLIB_PTR_DECL pLogMagnDst, const SLArrayIndex_t ArrayLength)
{
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {    // Calculate log and account for zero
    ...
    // printf ("[%d] = pSrcReal = %lf, pSrcImag = %lf, SquareMagnitudeSum =
...
void SIGLIB_FUNC_DECL SDA_LogMagnitudeAndPhaseWrapped(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                                      SLData_t* SIGLIB_PTR_DECL pLogMagnDst, SLData_t* SIGLIB_PTR_DECL pPhaseDst,
                                                      const SLArrayIndex_t ArrayLength)
{
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {
    SLData_t SquareMagnitudeSum = ((*pSrcReal) * (*pSrcReal)) + ((*pSrcImag) * (*pSrcImag));
...
void SIGLIB_FUNC_DECL SDA_LogMagnitudeAndPhaseUnWrapped(const SLData_t* SIGLIB_PTR_DECL pSrcReal, const SLData_t* SIGLIB_PTR_DECL pSrcImag,
                                                        SLData_t* SIGLIB_PTR_DECL pLogMagnDst, SLData_t* SIGLIB_PTR_DECL pPhaseDst,
                                                        const SLArrayIndex_t ArrayLength)
{
  for (SLArrayIndex_t i = 0; i < ArrayLength; i++) {
...
void SIGLIB_FUNC_DECL SIF_ReSize(SLArrayIndex_t* pStateLength)
{
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_ReSize(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, SLData_t* SIGLIB_PTR_DECL pState,
                                           SLArrayIndex_t* pStateLength, const SLArrayIndex_t SrcLength, const SLArrayIndex_t DstLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_ReSizeInput(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pState, SLArrayIndex_t* pStateLength,
                                      const SLArrayIndex_t SrcLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLArrayIndex_t SIGLIB_FUNC_DECL SDA_ReSizeOutput(SLData_t* SIGLIB_PTR_DECL pDst, SLData_t* SIGLIB_PTR_DECL pState, SLArrayIndex_t* pStateLength,
                                                 const SLArrayIndex_t DstLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_Fill(SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t FillValue, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pDst % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_Histogram(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t SourceMin,
                                    const SLData_t SourceMax, const SLArrayIndex_t SrcLength, const SLArrayIndex_t HistogramLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_HistogramCumulative(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t SourceMin,
                                              const SLData_t SourceMax, const SLArrayIndex_t SrcLength, const SLArrayIndex_t HistogramLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
#  endif
  ...
  for (SLArrayIndex_t i = 0; i < SrcLength; i++) {
    ...
    if ((Src >= Min) && (Src < Max)) {
      // Increment the cumulative histogram entries for the Nth bin and all
      // higher bins This is not the most elegant solution but it does allow the
      // function to operate such that successive iterations of the function are
      // cumulative
...
void SIGLIB_FUNC_DECL SDA_HistogramExtended(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t SourceMin,
                                            const SLData_t SourceMax, const SLArrayIndex_t SrcLength, const SLArrayIndex_t HistogramLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_HistogramExtendedCumulative(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst,
                                                      const SLData_t SourceMin, const SLData_t SourceMax, const SLArrayIndex_t SrcLength,
...
void SIGLIB_FUNC_DECL SIF_Histogram(SLData_t* SIGLIB_PTR_DECL pHistArray, const SLArrayIndex_t HistoryArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__                   // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_HistogramEqualize(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t NewPeak,
                                            const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
void SIGLIB_FUNC_DECL SDA_Quantize(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t quantisation,
                                   const SLData_t peakInputValue, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
#  endif
  ...
  SLData_t Max =
      (SLData_t)((SLUFixData_t)SIGLIB_FIX_MAX >> (SLUFixData_t)(SIGLIB_FIX_WORD_LENGTH - quantisation));    // Calculate quantisation factor
...
SLData_t SIGLIB_FUNC_DECL SDS_Quantize(const SLData_t src, const SLArrayIndex_t quantisation, const SLData_t peakInputValue)
{
  SLData_t Max =
      (SLData_t)((SLUFixData_t)SIGLIB_FIX_MAX >> (SLUFixData_t)(SIGLIB_FIX_WORD_LENGTH - quantisation));    // Calculate quantisation factor
...
void SIGLIB_FUNC_DECL SDA_Quantize_N(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t N,
                                     const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLData_t SIGLIB_FUNC_DECL SDS_Quantise_N(const SLData_t src, const SLData_t N)
{
...
void SIGLIB_FUNC_DECL SDA_Abs(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SIGLIB_FUNC_DECL SDS_PeakValueToBits(SLData_t PeakValue, enum SLSignalSign_t SignType)
{
...
SLData_t SIGLIB_FUNC_DECL SDS_BitsToPeakValue(SLData_t NumberOfBits, enum SLSignalSign_t SignType)
{
  if (SignType == SIGLIB_UNSIGNED_DATA) {
...
SLData_t SIGLIB_FUNC_DECL SDS_VoltageTodBm(const SLData_t Linear, const SLData_t ZerodBmLevel)
{
...
void SIGLIB_FUNC_DECL SDA_VoltageTodBm(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t ZerodBmLevel,
                                       const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLData_t SIGLIB_FUNC_DECL SDS_dBmToVoltage(const SLData_t dBm, const SLData_t ZerodBmLevel)
{
...
void SIGLIB_FUNC_DECL SDA_dBmToVoltage(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLData_t ZerodBmLevel,
                                       const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
...
SLData_t SDS_VoltageTodB(SLData_t linearGain)
{
...
void SIGLIB_FUNC_DECL SDA_VoltageTodB(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SDS_dBToVoltage(SLData_t dB)
{
...
void SIGLIB_FUNC_DECL SDA_dBToVoltage(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SDS_PowerTodB(SLData_t linearGain)
{
...
void SIGLIB_FUNC_DECL SDA_PowerTodB(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLData_t SDS_dBToPower(SLData_t dBm)
{
...
void SIGLIB_FUNC_DECL SDA_dBToPower(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
SLFixData_t SIGLIB_FUNC_DECL SDS_Compare(const SLData_t Src1, const SLData_t Src2, const SLData_t Threshold)
{
  ...
  if (Difference > LocalThreshold) {
    return (SIGLIB_FALSE);    // Difference between samples is greater than the
                              // threshold
  }
...
SLFixData_t SIGLIB_FUNC_DECL SDA_Compare(const SLData_t* SIGLIB_PTR_DECL pSrc1, const SLData_t* SIGLIB_PTR_DECL pSrc2, const SLData_t Threshold,
                                         const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__              // Defined by TI compiler
...
SLFixData_t SIGLIB_FUNC_DECL SDS_CompareComplex(const SLData_t SrcReal1, const SLData_t SrcImag1, const SLData_t SrcReal2, const SLData_t SrcImag2,
                                                const SLData_t Threshold)
{
  SLData_t LocalThreshold = Threshold;
...
SLFixData_t SIGLIB_FUNC_DECL SDA_CompareComplex(const SLData_t* SIGLIB_PTR_DECL pSrcReal1, const SLData_t* SIGLIB_PTR_DECL pSrcImag1,
...
SLData_t SIGLIB_FUNC_DECL SDS_Int(const SLData_t Src)
{
...
SLData_t SIGLIB_FUNC_DECL SDS_Frac(const SLData_t Src)
{
...
SLData_t SIGLIB_FUNC_DECL SDS_AbsFrac(const SLData_t Src)
{
  if (Src >= SIGLIB_ZERO) {
    return (Src - ((SLData_t)((SLArrayIndex_t)Src)));
  } else {
...
void SIGLIB_FUNC_DECL SDA_Int(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_Frac(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
...
void SIGLIB_FUNC_DECL SDA_AbsFrac(const SLData_t* SIGLIB_PTR_DECL pSrc, SLData_t* SIGLIB_PTR_DECL pDst, const SLArrayIndex_t ArrayLength)
{
#if (SIGLIB_ARRAYS_ALIGNED)
#  ifdef __TMS320C6X__             // Defined by TI compiler
  _nassert((int)pSrc % 8 == 0);    // Align arrays on 64 bit double word boundary for LDDW
